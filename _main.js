 ...
 $('#play').css("display", "none");
  ...
  //************************************************************************
    ...
    function preload() {
        ...
        let imagesFolder = "https://cnjdev.github.io/SpaceCowboy/images/";
        
        game.load.image("background", imagesFolder+"new-background-2.png")
        
        game.load.atlas('hero', imagesFolder+"PlayerShip.png", imagesFolder+"PlayerShip.json")
        game.load.atlas('laser', imagesFolder+"HeroLaser.png", imagesFolder+"HeroLaser.json")
        game.load.atlas('explosion', imagesFolder+"Explosion.png", imagesFolder+"Explosion.json")
        game.load.atlas('boss1', imagesFolder+"Boss1.png", imagesFolder+"Boss1.json")

        game.load.image("planet", imagesFolder+"coldPlanet.png");
        game.load.image("enemy1", imagesFolder+"EnemyShip1.png");
        game.load.image("enemy2", imagesFolder+"EnemyShip2.png");
        game.load.image("enemy3", imagesFolder+"EnemyShip3.png")
        game.load.image("enemyBullet1", imagesFolder+"enemyBullet1.png");
        game.load.image("flames", imagesFolder+"flame_new.png");
        game.load.image("upgradeLbl", imagesFolder+"weaponUpgrade.png");
        game.load.image("black-Background", imagesFolder+"black_screen.jpg");
        game.load.image("startBtn", imagesFolder+"start_button.png");
        game.load.image("gameOverImg", imagesFolder+"gameover3.png")
        
        //planets
        game.load.image("kamioBg", imagesFolder+"kamioBackground.jpg");
        game.load.image("mustafarBg", imagesFolder+"mustafarBackground.jpg");
        game.load.image("hothBg", imagesFolder+"hothBackground.jpg");
        game.load.image("rodiaBg", imagesFolder+"rodiaBackground.png");
        game.load.image("tatBg", imagesFolder+"tatooineBackGround.jpeg");

        game.load.image("cold-planet", imagesFolder+"coldPlanet.png");
        game.load.image("hot-planet", imagesFolder+"hotPlanet.png");
        game.load.image("frozen-planet", imagesFolder+"frozenPlanet.png");
        game.load.image("mild-planet", imagesFolder+"mildPlanet.png");
        game.load.image("warm-planet", imagesFolder+"warmPlanet2.png");

        //Audio 
        let audioFolder = "https://cnjdev.github.io/SpaceCowboy/audio/";
        game.load.audio("blaster", audioFolder+"panlaser.mp3")
        game.load.audio("game_over", audioFolder+"game_over.wav")
        game.load.audio("backGround-music", audioFolder+"kick_shock.wav")
        game.load.audio("booster", audioFolder+"booster.wav")
        game.load.audio("enemyExp", audioFolder+"enemyExplode.wav")
        game.load.audio("showPlanets", audioFolder+"showPlanets.mp3")    
